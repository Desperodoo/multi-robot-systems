...
# 绘制动态图
def sim_moving(step, height, width, obstacles, boundary_obstacles, extended_obstacles, box_width, n_p, n_e, p_x, p_y, e_x, e_y, path,
    ...
    imageio.mimsave(dir + '.gif', image_list, 'GIF', duration=0.1)
